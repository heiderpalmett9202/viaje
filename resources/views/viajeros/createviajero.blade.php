        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well well-sm">
                    <form class="form-horizontal" method="POST" action="{{route('viajero.store')}}" enctype="multipart/form-data">{{-- aca coloco la ruta para que me guarde en la base de datos --}}
                        @csrf
                        <fieldset>
